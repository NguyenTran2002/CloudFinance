...
class test_get_cumulative_expenses_by_day_in_a_month(unittest.TestCase):
    ...
    def test_get_cumulative_expenses_by_day_in_a_month(self):
        ...
        produced_june_2016_df = monthly.get_cumulative_expenses_by_day_in_a_month(self.sample_df, 2016, 6)
        produced_august_2019_df = monthly.get_cumulative_expenses_by_day_in_a_month(self.sample_df, 2019, 8)
